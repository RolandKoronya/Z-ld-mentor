...
// Now using native JS for cosine similarity to avoid npm build failures.

import { GoogleGenAI } from "@google/genai";
// import cosineSimilarity from "cosine-similarity"; // ❌ REMOVED: Replaced by manual function below
        ...
        search: async (query, { k = 6 } = {}) => {
            ...
            const hits = kb.chunks
                .map(chunk => {
                    ...
                    // ➡️ Use the manual function instead of the imported package
